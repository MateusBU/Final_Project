    ...
    <div class="article-admin">
        <b-form>
            ...
            <b-form-group label="Name:" label-for="article-name">
                <b-form-input id="article-name" type="text"
                    ...
                    placeholder="Inform Name of Article..." />
            </b-form-group>
            <b-form-group label="Description" label-for="article-description">
                <b-form-input id="article-description" type="text"
                    ...
                    :readonly="mode === 'remove'"
                    placeholder="Informe o Description of Article..." />
            </b-form-group>
            ...
            <!-- <b-form-group v-if="mode === 'save'"
                ...
                <QuillEditor v-model="article.content"
                    placeholder="Inform Article Content..." />
            </b-form-group> -->
        ...
        <b-table hover striped :items="articles" :fields="fields">
            <template v-slot:cell(actions)="data">
                <b-button variant="warning" @click="loadArticle(data.item)" class="me-2 mb-1">
